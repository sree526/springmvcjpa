...
<body>
    ...
    <h2><spring:message code="lbl.page" text="Update Or Delete Phone" /></h2>
    <br/>
    <form:form method="post" modelAttribute="phone">
        <table>
            ...
            <tr>
                <td colspan="3"><input type="submit" name="update" value="Update Phone"/></td>
            </tr>
        </table>
    </form:form>
    <form:form method="DELETE" modelAttribute="phone">
      <table>
        <tr>
             <td colspan="3"><input type="submit" name="delete" value="Delete Phone"/></td>
        </tr>
      </table>
    </form:form>
</body>
